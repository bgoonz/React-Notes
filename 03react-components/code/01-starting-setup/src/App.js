...
function App() {
  ...
  return (
    <div>
      ...
      //document.getElementById('root') // const pararaph =
      document.createElement('p') // paragraph.textContent = 'this is also
      visible' //document.getElementById('root').append(paragraph)
    </div>
  );
}
